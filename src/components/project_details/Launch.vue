<template>
  <section class="launch padding-default" v-bind:class="{ 'bg-grey': launch.bgGrey }">
    <div class="container">
      <div class="row center">
        <div :class="launch.topCol">
          ...
          <a :href="launch.url" class="btn btn-small top-2" :class="launch.btnClasses" target="_blank">{{ launch.btnText }}</a>
        </div>
      </div>
